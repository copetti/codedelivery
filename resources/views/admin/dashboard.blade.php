                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge">{{ $countStatus['novo'] }}</div>
                            <div>Novos Pedidos</div>
                        </div>
                    </div>
                </div>
                <a href="{{ route('admin.orders.filter',['status'=>'novo']) }} ">
            ...
            <div class="panel panel-yellow">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge">{{ $countStatus['atendimento'] }}</div>
                            <div>Em Atendimento</div>
                        </div>
                    </div>
                </div>
                <a href="{{ route('admin.orders.filter',['status'=>'atendimento']) }} ">
                    <div class="panel-footer">
                        <span class="pull-left">Ver Detalhes</span>
                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                        <div class="clearfix"></div>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge">{{ $countStatus['entregando'] }}</div>
                            <div>Pedidos em transporte</div>
                        </div>
                    </div>
                </div>
                <a href="{{ route('admin.orders.filter',['status'=>'entregando']) }} ">
                    <div class="panel-footer">
                        <span class="pull-left">Ver Detalhes</span>
                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                        <div class="clearfix"></div>
            ...
            <div class="panel panel-green">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge">{{ $countStatus['entregue'] }}</div>
                            <div>Pedidos Entregues</div>
                        </div>
                    </div>
                </div>
                <a href="{{ route('admin.orders.filter',['status'=>'entregue']) }} ">
                    <div class="panel-footer">
                        <span class="pull-left">Ver Detalhes</span>
                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                        <div class="clearfix"></div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge">{{ $countStatus['cancelado'] }}</div>
                            <div>Pedidos Cancelados</div>
                        </div>
                    </div>
                </div>
                <a href="{{ route('admin.orders.filter',['status'=>'cancelado']) }} ">
                    <div class="panel-footer">
                        <span class="pull-left">Ver Detalhes</span>
                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                        <div class="clearfix"></div>
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge">{{ $countStatus['todos'] }}</div>
